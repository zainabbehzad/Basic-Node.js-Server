const books = [
  { id: 1, title: 'The Alchemist', author: 'Paulo Coelho', rating: 5, review: 'A beautiful tale about following your dreams.' },
  { id: 2, title: 'To Kill a Mockingbird', author: 'Harper Lee', rating: 5, review: 'A powerful exploration of morality and human behavior.' },
  { id: 3, title: '1984', author: 'George Orwell', rating: 4, review: 'A chilling depiction of totalitarianism and surveillance.' },
  { id: 4, title: 'Pride and Prejudice', author: 'Jane Austen', rating: 5, review: 'A classic romantic novel that critiques societal norms.' },
  { id: 5, title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', rating: 4, review: 'A tragic story of love and ambition in the Jazz Age.' },
  { id: 6, title: 'Moby Dick', author: 'Herman Melville', rating: 4, review: 'An epic tale of obsession and the sea.' },
